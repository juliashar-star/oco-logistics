...
**offers/confirm** (POST). {"offer_id": "..."} → {"request_id": "..."}.
  ...
  про истёкший оффер. НЕ БЫЛО ПРОВЕРЕНО НА МОМЕНТ ЗАПИСИ — СНЯТО живой пробой 13.07.2026, записанной 23.07, см. строку 135. Это был критический пробел: если
...
> **ОТМЕНЕНО 06.09.2026 В ЧАСТИ ЧИСЕЛ.** Прочитан первоисточник — «Условия оказания услуг
> корпоративным клиентам сервиса Яндекс.Доставка», редакция 28.08.2026, раздел 3.2
> (`contracts/yandex-usloviya-2026-08-28.md`; разбор — `docs/YANDEX.md` §2.1).
>
> **Потолка 1 000 ₽ в договоре НЕТ.** Без объявленной ценности возмещение идёт **в размере двойной
> стоимости услуги по организации доставки** — то есть зависит от цены доставки, а не является
> фиксированной суммой. С объявленной ценностью потолок **различается по видам доставки**:
> 250 000 ₽ отложенная, 500 000 ₽ экспресс.
>
> **Само наблюдение о противоречии маркетинга и справки остаётся ВЕРНЫМ** — отменены только цифры,
> взятые со справочной страницы. **Уточнять письменно у менеджера больше не нужно: договор
> прочитан.**
